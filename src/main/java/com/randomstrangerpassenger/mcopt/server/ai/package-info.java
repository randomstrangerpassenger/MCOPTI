 ...
 * <h2>Components</h2>
 *
 * <h3>Math Caching ({@link com.randomstrangerpassenger.mcopt.server.ai.MathCache})</h3>
 ...
 * </ul>
 *
 * <h3>AI Goal Management ({@link com.randomstrangerpassenger.mcopt.server.ai.AIOptimizationSystem})</h3>
 ...
 * </ul>
 *
 * <h3>Optimized Controllers ({@link com.randomstrangerpassenger.mcopt.server.ai.OptimizedLookControl})</h3>
 ...
 * <h2>Subpackages</h2>
 * <ul>
 *   <li>{@link com.randomstrangerpassenger.mcopt.server.ai.filters} - Goal filtering interfaces and implementations</li>
 *   <li>{@link com.randomstrangerpassenger.mcopt.server.ai.modifiers} - Goal modification chain system</li>
 * </ul>
 *
 ...
 * </ul>
 *
 * @see com.randomstrangerpassenger.mcopt.server.ai.AIOptimizationSystem Main orchestrator
 * @see com.randomstrangerpassenger.mcopt.server.ai.MathCache Math lookup tables
